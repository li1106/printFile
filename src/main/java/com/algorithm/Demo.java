...
public class Demo {
    public static void main(String[] args) {
        ...
        log.debug("归并 method result is:{}",gbSort());

        log.debug("快速 method result is:{}",fastSort());

        log.debug("希尔 method result is:{}",xrSort());

        log.debug("插入 method result is:{}",crSort());

        log.debug("选择 method result is:{}",xzSort());

        log.debug("冒泡 method result is:{}",mpSort());
